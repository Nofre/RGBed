...
//        }
    ...
    STFT(int fftLen, int hopLen, int sampleRate, int nFFTAverage, String wndFuncName, boolean boolAWeighting) {
        init(fftLen, hopLen, sampleRate, nFFTAverage, wndFuncName);
        this.boolAWeighting = boolAWeighting;
    }
